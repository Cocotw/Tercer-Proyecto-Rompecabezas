...
var instrucciones = ["Mover Las Imagenes Para Completar a BMO", "Ordenar Correctamente Las Imagenes" , "Lograr El Objetivo"];
...
function mostrarInstrucciones(instrucciones) {
  var mostrar1 = instrucciones[0];
  var mostrar2 = instrucciones[1];
  var mostrar3 = instrucciones[2];
  mostrarInstruccionEnLista(mostrar1, "lista-instrucciones");
  mostrarInstruccionEnLista(mostrar2, "lista-instrucciones");
  mostrarInstruccionEnLista(mostrar3, "lista-instrucciones");
}
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
    var intercambio = grilla[filaPos1][columnaPos1];
    grilla[filaPos1][columnaPos1] = grilla[filaPos2][columnaPos2];
    grilla[filaPos2][columnaPos2] = intercambio;
}
